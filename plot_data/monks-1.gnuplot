...
plot "monks-1.tab" every ::1 using 1:2 ls 1 title "knn",\
     "monks-1.tab" every ::1 using 1:4 ls 2 title "svm",\
     "monks-1.tab" every ::1 using 1:6 ls 3 title "tree",\
     "monks-1.tab" every ::1 using 1:8 ls 4 title "majority",\
     "monks-1.tab" every ::1 using 1:10 ls 5 title "bayes",\
     "monks-1.tab" every ::1 using 1:12 ls 6 title "neural net"
