...
plot "wine.tab" every ::1 using 1:2 ls 1 title "knn",\
     "wine.tab" every ::1 using 1:4 ls 2 title "svm",\
     "wine.tab" every ::1 using 1:6 ls 3 title "tree",\
     "wine.tab" every ::1 using 1:8 ls 4 title "majority",\
     "wine.tab" every ::1 using 1:10 ls 5 title "bayes",\
     "wine.tab" every ::1 using 1:12 ls 6 title "neural net"
